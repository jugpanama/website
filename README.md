...
Los eventos se administran en `content/events/`, las notas técnicas en
`content/notes/` y los sponsors o aliados en `content/sponsors/`. Usa
`published: false` para conservar un borrador sin mostrarlo en el sitio.
